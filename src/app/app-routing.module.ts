...
const routes: Routes = [
  ...
  { path: '2fa', component: TwoFactorAuthenticatorComponent },
  { path: '2fa-qr', component: GoogleAuthenticatorSetupComponent },
  ...
  { path: 'cancellist', component: CancelOrderComponent, canActivate: [AuthGuard] },
